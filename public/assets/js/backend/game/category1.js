define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/category1/index' + location.search,
                    add_url: 'game/category1/add',
                    edit_url: 'game/category1/edit',
                    del_url: 'game/category1/del',
                    multi_url: 'game/category1/multi',
                    import_url: 'game/category1/import',
                    table: 'game_category1',
                }
            });
